...
export const APPLICATION_FIELDS = [
  ...
  { key: "preferredname", label: "Preferred Name", widget: "text", manatalId: "1741685", required: true },
  {
  ...
  { key: "birth_date", label: "Date of Birth", widget: "date", manatalId: "1741687", required: true },
  {
    key: "gender",
    label: "Gender",
    widget: "select",
  ...
  { key: "religion", label: "Religion", widget: "text", manatalId: "1741689", required: true },
  {
    key: "nricfin",
    label: "NRIC/FIN",
    widget: "nricfin",
  ...
  { key: "passportno", label: "Passport Number", widget: "text", manatalId: "1741693", required: true },
  {
  ...
  { key: "address", label: "Complete Address", widget: "text", manatalId: "1741696", required: true },
  {
    key: "postalcode",
    label: "Postal Code",
    widget: "postalcode",
  ...
  { key: "name", label: "Emergency Contact Name", widget: "text", manatalId: "1741699", required: true },
  {
    key: "relationship",
  ...
  // 06 - Other courses
  { key: "coursename", label: "Course Name", widget: "text", manatalId: "1741710" },
  { key: "coursestartdate", label: "Course Start Date", widget: "date", manatalId: "1741711" },
  {
